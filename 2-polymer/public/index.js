 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=` ${d} `;class v{constructor(e,t,r,s){this.strings=e,this.values=t,this.type=r,this.processor=s}getHTML(){const e=this.strings.length-1;let t="",r=!1;for(let s=0;s<e;s++){const e=this.strings[s],n=e.lastIndexOf("\x3c!--");r=(n>-1||r)&&-1===e.indexOf("--\x3e",n+1);const i=g.exec(e);t+=null===i?e+(r?_:h):e.substr(0,i.index)+i[1]+i[2]+"$lit$"+i[3]+d}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const $=(e,...t)=>new v(e,t,"html",j);function U(e,t){const{element:{content:r},parts:s}=e,n=document.createTreeWalker(r,133,null,!1);let i=I(s),o=s[i],a=-1,l=0;const c=[];let d=null;for(;n.nextNode();){a++;const e=n.currentNode;for(e.previousSibling===d&&(d=null),t.has(e)&&(c.push(e),null===d&&(d=e)),null!==d&&l++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-l,i=I(s,i),o=s[i]}c.forEach(e=>e.parentNode.removeChild(e))}const z=e=>{let t=11===e.nodeType?0:1;const r=document.createTreeWalker(e,133,null,!1);for(;r.nextNode();)t++;return t},I=(e,t=-1)=>{for(let r=t+1;r<e.length;r++){const t=e[r];if(y(t))return r}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 */ie.finalized=!0,ie.render=(e,t,r)=>{if(!r||"object"!=typeof r||!r.scopeName)throw new Error("The `scopeName` option is required.");const s=r.scopeName,n=M.has(t),i=F&&11===t.nodeType&&!!t.host,o=i&&!W.has(s),l=o?document.createDocumentFragment():t;if(((e,t,r)=>{let s=M.get(t);void 0===s&&(a(t,t.firstChild),M.set(t,s=new C(Object.assign({templateFactory:R},r))),s.appendInto(t)),s.setValue(e),s.commit()})(e,l,Object.assign({templateFactory:L(s)},r)),o){const e=M.get(l);M.delete(l);const r=e.value instanceof b?e.value.template:void 0;B(s,l,r),a(t,t.firstChild),t.appendChild(l),M.set(t,e)}!n&&i&&window.ShadyCSS.styleElement(t.host)};const ae=new WeakMap,le=n(e=>t=>{if(!(t instanceof P)||t instanceof O||"style"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `styleMap` directive must be used in the style attribute and must be the only part in the attribute.");const{committer:r}=t,{style:s}=r.element;ae.has(t)||(s.cssText=r.strings.join(" "));const n=ae.get(t);for(const t in n)t in e||(-1===t.indexOf("-")?s[t]=null:s.removeProperty(t));for(const t in e)-1===t.indexOf("-")?s[t]=e[t]:s.setProperty(t,e[t]);ae.set(t,e)});var ce=function(e,t,r,s){var n,i=arguments.length,o=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(i<3?n(o):i>3?n(t,r,o):n(t,r))||o);return i>3&&o&&Object.defineProperty(t,r,o),o};let de=class extends ie{render(){return $`
  ...
  `,ce([Z({type:String})],de.prototype,"visibility",void 0),de=ce([X("four-dot-winneralert")],de);var he=function(e,t,r,s){var n,i=arguments.length,o=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(i<3?n(o):i>3?n(t,r,o):n(t,r))||o);return i>3&&o&&Object.defineProperty(t,r,o),o};let ue=class extends ie{restartGame(){this.dispatchEvent(new CustomEvent("restart-game",{bubbles:!0,composed:!0}))}render(){return $`
      <header>
        <h1>Four Dots</h1>
  ...
  `,ue=he([X("four-dot-header")],ue);var pe=function(e,t,r,s){var n,i=arguments.length,o=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(i<3?n(o):i>3?n(t,r,o):n(t,r))||o);return i>3&&o&&Object.defineProperty(t,r,o),o};let fe=class extends ie{addDot(){this.dispatchEvent(new CustomEvent("add-dot",{bubbles:!0,composed:!0,detail:{currentPlayer:this.currentPlayer,colIndex:this.colIndex}})),this.dispatchEvent(new CustomEvent("change-player",{bubbles:!0,composed:!0,detail:{currentPlayer:"blue"==this.currentPlayer?"black":"blue"}}))}render(){return $`
...
const ye=new WeakMap,me=n(e=>t=>{if(!(t instanceof P)||t instanceof O||"class"!==t.committer.name||t.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:r}=t,{element:s}=r;ye.has(t)||(s.className=r.strings.join(" "));const{classList:n}=s,i=ye.get(t);for(const t in i)t in e||n.remove(t);for(const t in e){const r=e[t];if(!i||r!==i[t]){n[r?"add":"remove"](t)}}ye.set(t,e)});var ge=function(e,t,r,s){var n,i=arguments.length,o=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(i<3?n(o):i>3?n(t,r,o):n(t,r))||o);return i>3&&o&&Object.defineProperty(t,r,o),o};let be=class extends ie{render(){return $`
  ...
  `,_e([Z({type:Array})],ve.prototype,"board",void 0),_e([Z({type:String})],ve.prototype,"currentPlayer",void 0),_e([Z({type:Number})],ve.prototype,"counter",void 0),ve=_e([X("four-dot-board")],ve),r.d(t,"FourDotsApp",(function(){return we}));var Se=function(e,t,r,s){var n,i=arguments.length,o=i<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,r):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,r,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(i<3?n(o):i>3?n(t,r,o):n(t,r))||o);return i>3&&o&&Object.defineProperty(t,r,o),o};let we=class extends ie{constructor(){super(),this.board=oe("blue"),this.currentPlayer="blue",this.visibility="hidden",this.addEventListener("restart-game",this.restartGame),this.addEventListener("add-dot",this.updateGameState),this.addEventListener("change-player",this.changePlayer)}restartGame(){console.log("this.board",this.board),this.currentPlayer="blue",this.visibility="hidden",this.board=oe("green")}updateGameState(e){console.log("updateGameState",e.detail)}changePlayer(e){this.currentPlayer=e.detail.currentPlayer}render(){return $`
      <div>
